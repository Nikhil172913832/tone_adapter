...
import { 
	...
	QUESTION_RE, INTERJECTION_RE, REPETITION_RE, COMPLEX_SENTENCE_RE,
	PASSIVE_VOICE_RE, FIRST_PERSON_RE, SECOND_PERSON_RE, THIRD_PERSON_RE,
	UNCERTAINTY_RE, CONFIDENCE_RE, HUMOR_RE, TECHNICAL_RE, EMPATHY_RE,
	TIME_RE, SPATIAL_RE, POSITIVE_WORDS, NEGATIVE_WORDS
} from './patterns';
import { countMatches, getVocabularyDiversity, analyzeSentences, calculateSentimentScore } from './utils';

export function calculateDetailedMetrics(texts: string, messages: string[], totalMsgs: number): ToneProfile['metrics'] {
